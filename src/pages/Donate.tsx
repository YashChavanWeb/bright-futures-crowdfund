...
const Donate = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      ...
      <div className="py-20 px-4 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center mb-16 text-white">
            <Button
              onClick={() => navigate('/')}
              variant="outline"
              className="mb-8 border-white/30 text-white hover:bg-white/10 rounded-full"
            >
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Campaign
            </Button>
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Make Your Impact</h1>
